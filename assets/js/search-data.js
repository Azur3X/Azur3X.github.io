...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "Important notice! The dates in the work experience section  can be seen more precisely in the PDF version.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D%61%74%68%6A%32%34@%73%74%75%64%65%6E%74.%73%64%75.%64%6B", "_blank");
        },
      },{
        id: 'social-facebook',
        title: 'Facebook',
        section: 'Socials',
        handler: () => {
          window.open("https://facebook.com/mathias.bondejensen", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/Azur3X_bonde", "_blank");
        },
      },{
      id: 'light-theme',
